...
import {
  MainContainer,
  Title
} from "/build/_shared/chunk-RKNDT5IN.js";
import {
  AntdIcon_default,
...
function TrackingDetails() {
  ...
  const handleClick = async () => {
    if (!trackingId) {
      ...
      setIsLoading(true);
      const data2 = await getTrackingDetails(trackingId);
      setData({ ...data2 });
      setIsLoading(false);
    }
  };
  ...
  }))), isLoading ? /* @__PURE__ */ import_react2.default.createElement("div", null, "Loading") : !data?.err && /* @__PURE__ */ import_react2.default.createElement(MainContainer, null, /* @__PURE__ */ import_react2.default.createElement("div", {
    className: "order-info-container"
  }, /* @__PURE__ */ import_react2.default.createElement("div", {
    style: { marginBottom: "30px" }
  }, isMultiOrder ? data?.response_list?.map((trackingData, index) => {
    const {
      courier_used,
      status,
      order_created_at,
...
//! momentjs.com
//! version : 2.29.3
//# sourceMappingURL=/build/routes/tracking/$index-VMWQ2TVS.js.map
